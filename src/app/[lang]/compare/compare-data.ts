...
export const competitors: Record<string, CompetitorData> = {
  smallpdf: {
    slug: "smallpdf",
    name: "Smallpdf",
    tagline: "Why pay $12/mo for 30 PDF tools when $2.59 gets you 120+?",
    price: "$12/mo",
    priceNum: 12,
    multiplier: "4.6x",
    toolCount: "30+",
    ...
    faq: [
      ...
      },
      {
        ...
        a: "JustUse.me is the most affordable alternative at $2.59/month for 120+ tools — 4.6x cheaper than Smallpdf's $12/month. The free tier has no watermarks and covers most common tasks.",
      },
      {
      ...
      },
      {
        ...
        a: "It depends on your needs. Smallpdf is better for advanced PDF editing, OCR, and e-signatures. JustUse.me is better for value ($2.59 vs $12/month), privacy (no file uploads), and breadth (120+ tools across 8 categories vs 30+ PDF-only tools).",
      },
    ],
    relatedTools: [
      "merge-pdf",
  ...
  ilovepdf: {
    ...
    faq: [
      ...
      },
      {
        ...
        a: "iLovePDF is better for high-volume batch processing and very large files (up to 4GB). JustUse.me is better for privacy (no uploads), price ($2.59 vs $7/month), variety (120+ tools vs ~25), and watermark-free output on all plans.",
      },
    ],
    relatedTools: [
      "merge-pdf",
    ...
    faq: [
      {
        ...
        a: "Adobe offers limited free online PDF tools (convert, compress, sign) with restrictions. The full Acrobat Pro editor costs $19.99/month. JustUse.me offers 120+ tools with a free tier and Pro at $2.59/month.",
      },
      {
    ...
    sections: [
      {
        ...
        content:
          "TinyPNG does one thing: compress images. It does it well — their compression algorithm produces excellent results across JPEG, PNG, WebP, and AVIF formats. But their Web Pro plan costs $3.25 per month (billed annually) for unlimited compression with a 75MB file limit. JustUse.me costs $2.59 per month and includes image compression plus 120+ other tools. You get image resizing, cropping, format conversion, HEIC support, background removal, and OCR — along with PDF tools, text tools, code formatters, and more.",
      },
      {
      ...
      },
      {
        ...
        content:
          "TinyPNG is the right choice if you need their developer API for automated image optimization in build pipelines or CI/CD workflows. Their API pricing is separate from the web tool. For manual image compression through a web interface, JustUse.me offers the same capability plus 120+ additional tools at a lower price, with the added benefit of local processing.",
      },
    ],
    faq: [
      {
